        ...
        <div class="col-12">
          ...
          document.addEventListener("DOMContentLoaded", function () {
            ...
            function showToast(message, type='primary'){
              ...
              el.className = `bs-toast toast m-2 fade bg-${type} text-white show`;
            ...
            // ======== Estado global ========
            let CAT_PAGE = 1, CAT_SEARCH = '';
            let SUB_PAGE = 1, SUB_SEARCH = '';
              ...
              if (e.target.classList.contains('btn-del')) {
                ...
                .then(d=>{
                  ...
                  if (CAT_ACTIVE_ID && +CAT_ACTIVE_ID === +id) {
                    CAT_ACTIVE_ID = null; CAT_ACTIVE_NAME = null;
